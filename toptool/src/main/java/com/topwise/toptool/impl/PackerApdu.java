...
public class PackerApdu implements IApdu {
    ...
    private class ApduReq implements IApduReq {
        ...
        public byte[] pack() {
            ...
            if (lengthOfLc == 0) {
                ...
                convert.shortToByteArray((short)lc, request, offset, IConvert.EEndian.BIG_ENDIAN);
                offset += 2;
            }
            ...
            if (lengthOfLe == 0) {
                ...
                convert.shortToByteArray(Le, request, offset, IConvert.EEndian.BIG_ENDIAN);
                offset += 2;
            }
            return request;
        }
    ...
    private class ApduResp implements IApduResp {
        ...
        public void setRspDataAndStatus(byte[] dataAndStatus) {
            ...
            status = TopTool.getInstance().getConvert()
                    .shortFromByteArray(dataAndStatus, dataAndStatus.length - 2, IConvert.EEndian.BIG_ENDIAN);
        ...
        public String getStatusString() {
            ...
            TopTool.getInstance().getConvert().shortToByteArray(status, statusCode, 0, IConvert.EEndian.BIG_ENDIAN);
            return TopTool.getInstance().getConvert().bcdToStr(statusCode);
        }
