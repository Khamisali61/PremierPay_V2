...
public class AppLog {
    ...
    public static boolean DEBUG_V = DEBUG;
    /**
     * 控制android.util.Log.d是否输出
     */
    public static boolean DEBUG_D = DEBUG;
    /**
     * 控制android.util.Log.i是否输出
     */
    public static boolean DEBUG_I = DEBUG;
    /**
     * 控制android.util.Log.w是否输出
     */
    public static boolean DEBUG_W = DEBUG;
    /**
     * 控制android.util.Log.e是否输出
     */
    public static boolean DEBUG_E = DEBUG;
