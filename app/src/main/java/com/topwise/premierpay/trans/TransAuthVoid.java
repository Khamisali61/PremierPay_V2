 ...
 * 作者:  wangweicheng
 */
public class TransAuthVoid extends BaseTrans {
    private static final String TAG = TransAuthVoid.class.getSimpleName();
    private String title = "";
    private TransData origTransdata;

    public TransAuthVoid(Context context, Handler handler, TransEndListener transListener) {
        super(context, handler, ETransType.TRANS_PRE_AUTH_VOID, transListener);
        title = ETransType.TRANS_PRE_AUTH_VOID.getTransName().toUpperCase();
    }
        ...
        switch (state) {
            ...
            case ENTER_DATA:
                ...
                validateOrigTransData(data);
                  ...
                  //below are used for test iso 8583 message format
//                AppLog.d("TAG","OrigAuthCode=== " + data);
...
//                    transData.setPan("5186007600090864");
    ...
    protected void bindStateOnAction() {
        ...
        bind(State.CHECK_CARD.toString(), actionSearchCard);
...
//            }
//        });
//        bind(State.ENTER_AMOUNT.toString(), actionInputTransData);
    ...
    private void validateOrigTransData(String origTransNo){
        AppLog.d(TAG,"validateOrigTransData");
...
//            }
        ...
        //test
//        origTransdata = Component.transInit();
//        origTransdata.setTransType(ETransType.TRANS_PRE_AUTH.toString());
//        origTransdata.setAmount("000000000011");
//        origTransdata.setPan("5186007600090864");
//        origTransdata.setAuthCode("132456");
//        origTransdata.setRefNo("88888888");
//        origTransdata.setTransNo(13254678);
//        origTransdata.setDatetime("0805152203");
//        origTransdata.setDate("0805");
//        origTransdata.setTime("152203");
//        copyOrigTransData();
//        gotoState(State.TRANS_DETAIL.toString());
    }
    ...
    private void checkCardAndPin() {
        // 撤销是否需要刷卡
        if (SysParam.Constant.YES.equals(TopApplication.sysParam.get(SysParam.UCTC_PAVOID))) {
    ...
    private void checkPin() {
        if (SysParam.Constant.YES.equals(TopApplication.sysParam.get(SysParam.IPTC_PAVOID))) {
