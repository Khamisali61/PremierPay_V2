 ...
 * 作者:wangweicheng
 */
public class SearchCardManagerActivity extends BaseActivityWithTickForAction {
    private static final String TAG = TopApplication.APPNANE + SearchCardManagerActivity.class.getSimpleName();
    ...
    protected void initViews() {
        ...
        if (!TextUtils.isEmpty(amount)) {
            ...
            mTextAmount.setText(getString(R.string.trans_amount)+ curr+ Utils.ftoYuan(amount));
        } else {
        ...
        if (!TextUtils.isEmpty(amount_cash)) {
            ...
            mTextCashAmount.setText(getString(R.string.trans_amount_cash)+curr+Utils.ftoYuan(amount_cash));
        } else {
    ...
    * */
    private boolean isKeyin() {
        return ((mode & ActionSearchCard.SearchMode.KEYIN) == ActionSearchCard.SearchMode.KEYIN);
    }

    private boolean isSwipe() {
        return ((mode & ActionSearchCard.SearchMode.SWIPE) == ActionSearchCard.SearchMode.SWIPE);
    }
