...
public class ActionTransState extends AAction {
    /**
     * 子类构造方法必须调用super设置ActionStartListener
     *
     * @param listener {@link ActionStartListener}
     */
    public ActionTransState(ActionStartListener listener) {
        super(listener);
    }
    ...
    protected void process() {
        Intent intent = new Intent(context, ConsumeSuccessActivity.class);
