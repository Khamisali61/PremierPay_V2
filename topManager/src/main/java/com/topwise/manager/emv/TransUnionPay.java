...
import com.topwise.manager.emv.impl.EContactlessQpbocCallback;
...
public class TransUnionPay extends AClssKernelBaseTrans {
    ...
    public EmvOutCome StartKernelTransProc() {
        ...
        try {
            ...
            //todo 应返回0x20
            byte[] isGetPin = getTLV(0x9F34);
            if (isGetPin != null) {
                AppLog.d(TAG, "0x9F34: " + isGetPin[0]);
                if (isGetPin[0] == 0x02) {
                ...
                } else if (clssTransParam.isClssForceOnlinePin()) {
