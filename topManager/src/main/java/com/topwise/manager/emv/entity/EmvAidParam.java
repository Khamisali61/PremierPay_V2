...
public class EmvAidParam {
    ...
    private boolean bZeroCheckFlg;////DFC109, 0-alow(Option1), 1-not alow(Option2), 2-Deactived

    private String aucReaderTTQ;
    private boolean bReaderTTQFlg;//9F66

    private String aucRdClssTxnLmt;
    private boolean bRdClssTxnLmtFlg;//DF8124  //DF20
...
//            }
            ...
            if (emvAidParam.isbIFDFlg()) {
                ...
                //UL L3 JCB测试，终端号需要和案例配置的相同
                tlvList.addTlv("9F1E","3132333435363738");
            }
    ...
    public String toString() {
        return "EmvAidParam{" +
                "aid='" + aid + '\'' +
                ", bPartMatch=" + bPartMatch +
                ", aucKernType='" + aucKernType + '\'' +
                ", aucTmCap='" + aucTmCap + '\'' +
                ", bTmCapFlg=" + bTmCapFlg +
                ", aucTmCapAd='" + aucTmCapAd + '\'' +
                ", bTmCapAdFlg=" + bTmCapAdFlg +
                ", aucTACDefault='" + aucTACDefault + '\'' +
                ", bTACDefaultFlg=" + bTACDefaultFlg +
                ", aucTACDenail='" + aucTACDenail + '\'' +
                ", bTACDenailFlg=" + bTACDenailFlg +
                ", aucTACOnline='" + aucTACOnline + '\'' +
                ", bTACOnlineFlg=" + bTACOnlineFlg +
                ", aucAPPVer='" + aucAPPVer + '\'' +
                ", bAPPVerFlg=" + bAPPVerFlg +
                ", bTermTypeFlg=" + bTermTypeFlg +
                ", ucTermType=" + ucTermType +
                ", aucTermDDOL='" + aucTermDDOL + '\'' +
                ", bTermDDOLFlg=" + bTermDDOLFlg +
                ", aucTermTDOL='" + aucTermTDOL + '\'' +
                ", bTermTDOLFlg=" + bTermTDOLFlg +
                ", aucCountryCode='" + aucCountryCode + '\'' +
                ", bCountryCodeFlg=" + bCountryCodeFlg +
                ", aucCurrencyCode='" + aucCurrencyCode + '\'' +
                ", bCurrencyCodeFlg=" + bCurrencyCodeFlg +
                ", ucCurrencyExp=" + ucCurrencyExp +
                ", bCurrencyExpFlg=" + bCurrencyExpFlg +
                ", aucRefCurrencyCode='" + aucRefCurrencyCode + '\'' +
                ", bRefCurrencyCodeExt=" + bRefCurrencyCodeExt +
                ", ucRefCurrencyExp=" + ucRefCurrencyExp +
                ", bRefCurrencyExpExt=" + bRefCurrencyExpExt +
                ", aucRefCurrencyCon='" + aucRefCurrencyCon + '\'' +
                ", bRefCurrencyConExt=" + bRefCurrencyConExt +
                ", aucFloorLimit='" + aucFloorLimit + '\'' +
                ", bFloorLimitFlg=" + bFloorLimitFlg +
                ", aucThreshold='" + aucThreshold + '\'' +
                ", bThresholdFlg=" + bThresholdFlg +
                ", ucMaxTP=" + ucMaxTP +
                ", bMaxTPFlg=" + bMaxTPFlg +
                ", ucTP=" + ucTP +
                ", bTPFlg=" + bTPFlg +
                ", ucPosEntryMode=" + ucPosEntryMode +
                ", bPosEntryModeFlg=" + bPosEntryModeFlg +
                ", aucIFD='" + aucIFD + '\'' +
                ", bIFDFlg=" + bIFDFlg +
                ", aucTermID='" + aucTermID + '\'' +
                ", bTermIDFlg=" + bTermIDFlg +
                ", aucAcquireID='" + aucAcquireID + '\'' +
                ", bAcquireIDFlg=" + bAcquireIDFlg +
                ", ucStatusCheckVal=" + ucStatusCheckVal +
                ", bStatusCheckFlg=" + bStatusCheckFlg +
                ", ucZeroCheckVal=" + ucZeroCheckVal +
                ", bZeroCheckFlg=" + bZeroCheckFlg +
                ", aucReaderTTQ='" + aucReaderTTQ + '\'' +
                ", bReaderTTQFlg=" + bReaderTTQFlg +
                ", aucRdClssTxnLmt='" + aucRdClssTxnLmt + '\'' +
                ", bRdClssTxnLmtFlg=" + bRdClssTxnLmtFlg +
                ", aucRdClssTxnLmtOnDevice='" + aucRdClssTxnLmtOnDevice + '\'' +
                ", bRdClssTxnLmtOnDeviceFlg=" + bRdClssTxnLmtOnDeviceFlg +
                ", aucRdClssFLmt='" + aucRdClssFLmt + '\'' +
                ", bRdClssFLmtFlg=" + bRdClssFLmtFlg +
                ", aucRdCVMLmt='" + aucRdCVMLmt + '\'' +
                ", bRdCVMLmtFlg=" + bRdCVMLmtFlg +
                ", aucBalBeforeGAC='" + aucBalBeforeGAC + '\'' +
                ", bBalBeforeGACFlg=" + bBalBeforeGACFlg +
                ", aucBalAfterGAC='" + aucBalAfterGAC + '\'' +
                ", bBalAfterGACFlg=" + bBalAfterGACFlg +
                ", aucUDOL='" + aucUDOL + '\'' +
                ", bUDOLFlg=" + bUDOLFlg +
                ", aucTmCapNoCVM='" + aucTmCapNoCVM + '\'' +
                ", bTmCapNoCVMFlg=" + bTmCapNoCVMFlg +
                ", aucMagStripeVer='" + aucMagStripeVer + '\'' +
                ", bMagStripeVerFlg=" + bMagStripeVerFlg +
                ", ucMagStripeSupp=" + ucMagStripeSupp +
                ", bMagStripeSuppFlg=" + bMagStripeSuppFlg +
                ", aucMerchID='" + aucMerchID + '\'' +
                ", bMerchIDFlg=" + bMerchIDFlg +
                ", aucTRMData='" + aucTRMData + '\'' +
                ", bTRMDataFlg=" + bTRMDataFlg +
                ", aucMerchNameLoc='" + aucMerchNameLoc + '\'' +
                ", bMerchNameLocFlg=" + bMerchNameLocFlg +
                ", aucMerchCateCode='" + aucMerchCateCode + '\'' +
                ", bMerchCateCodeFlg=" + bMerchCateCodeFlg +
                ", aucMerchCustomData='" + aucMerchCustomData + '\'' +
                ", bMerchCustomDataFlg=" + bMerchCustomDataFlg +
                ", ucAccountType=" + ucAccountType +
                ", bAccountTypeFlg=" + bAccountTypeFlg +
                ", ucCrypto17Flg=" + ucCrypto17Flg +
                ", aucEnhancedCapa='" + aucEnhancedCapa + '\'' +
                ", bEnhancedCapaFlg=" + bEnhancedCapaFlg +
                '}';
    }
}
