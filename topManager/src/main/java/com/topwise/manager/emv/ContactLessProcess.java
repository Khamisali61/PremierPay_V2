...
import com.topwise.manager.emv.entity.ClssPreProcResult;
import com.topwise.manager.emv.entity.EmvOnlineResp;
import com.topwise.manager.emv.entity.EmvErrorCode;
import com.topwise.manager.emv.entity.ClssTransParam;
...
public class ContactLessProcess extends ABaseTransProcess {
        ...
        try {
            ...
            if (emvRest != EmvErrorCode.CLSS_OK) {
                ...
                if (EmvErrorCode.ICC_CMD_ERR == emvRest) {
                    ...
                    return new EmvOutCome(emvRest, ETransStatus.TRY_ANOTHER_INTERFACE, ETransStep.CLSS_ENTRY_BUILD_CANDI_DATE);
                }
            }
    ...
    private TlvList handleKernalData() {
        ...
        list.addTlv("9F39","07");
        list.addTlv("9F15", emvTransData.getMcc());
