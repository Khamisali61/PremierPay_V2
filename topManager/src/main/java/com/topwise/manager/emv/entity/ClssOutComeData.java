...
public class ClssOutComeData {
    ...
    public ClssOutComeData(byte [] aucOutcomeBuf) {
        this.ucOCStatus                         = (byte)(aucOutcomeBuf[0] & 0xFF);
        this.ucOCStart                          = (byte)(aucOutcomeBuf[1] & 0xFF);
        this.ucOCOnlineResponseData             = (byte)(aucOutcomeBuf[2] & 0xFF);
        this.ucOCCVM                            = (byte)(aucOutcomeBuf[3] & 0xFF);
        this.ucOCPresent                        = (byte)(aucOutcomeBuf[4] & 0xFF);
        this.ucOCAlternateInterfacePreference   = (byte)(aucOutcomeBuf[5] & 0xFF);
        this.ucOCFieldOffRequest                = (byte)(aucOutcomeBuf[6] & 0xFF);
        this.ucOCRemovalTimeout                 = (byte)(aucOutcomeBuf[7] & 0xFF);
    }
