...
public class EmvErrorCode {
    ...
    public static final int EMV_PARAMETER_ERROR     = 25; //paramerter error
...
//---------------------------------------------------------------------------
   ...
   public static final int QPBOC_USE_CONTACT                       =324;
    ...
    public static final int CLSS_CARD_NOT_SUPPORT       =    -52 ;    //Status Code returned by IC card is 6987, Please authenticate yourself to your device and try again
    ...
    public static final int CLSS_NEED_PWD             =    -304 ;   // VCAS More Card
    public static final int CLSS_NEED_CONTACT             =    -305 ;   // VCAS More Card
    ...
    public static final int CLSS_TRANSPATH_MAG = 10;
    public static final int CLSS_TRANSPATH_LEGACY = 20;
