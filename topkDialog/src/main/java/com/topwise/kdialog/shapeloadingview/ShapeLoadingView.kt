package com.topwise.kdialog.shapeloadingview
...
/**
 * 作者：wangwc on 2021/5/3 15:57
 */
class ShapeLoadingView : FrameLayout {
    private var mRxShapeView: ShapeView? = null
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.ShapeLoadingView)
    ...
    override fun onFinishInflate() {
        ...
        mRxShapeView = view.findViewById(R.id.shapeLoadingView) as ShapeView?
        mIndicationIm = view.findViewById(R.id.indication) as ImageView?
        mLoadTextView = view.findViewById(R.id.promptTV) as TextView?
    ...
    fun upThrow() {
        ...
        objectAnimator1 = when (mRxShapeView!!.shape) {
            ShapeView.Shape.SHAPE_RECT -> ObjectAnimator.ofFloat(mRxShapeView, "rotation", 0f, -120f)
            ShapeView.Shape.SHAPE_CIRCLE -> ObjectAnimator.ofFloat(mRxShapeView, "rotation", 0f, 180f)
            ShapeView.Shape.SHAPE_TRIANGLE -> ObjectAnimator.ofFloat(mRxShapeView, "rotation", 0f, 180f)
        }
